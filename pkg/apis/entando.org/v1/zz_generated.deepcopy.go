...
func (in *EntandoDatabaseServiceSpec) DeepCopyInto(out *EntandoDatabaseServiceSpec) {
	*out = *in
	out.JdbcParameters = in.JdbcParameters
	if in.EnvironmentVariables != nil {
		in, out := &in.EnvironmentVariables, &out.EnvironmentVariables
		*out = make([]corev1.EnvVar, len(*in))
		for i := range *in {
...
func (in *EntandoKeycloakServer) DeepCopy() *EntandoKeycloakServer {
	if in == nil {
		return nil
	}
	out := new(EntandoKeycloakServer)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EntandoKeycloakServerList) DeepCopyInto(out *EntandoKeycloakServerList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]EntandoKeycloakServer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EntandoKeycloakServerList) DeepCopy() *EntandoKeycloakServerList {
	if in == nil {
		return nil
	}
	out := new(EntandoKeycloakServerList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EntandoKeycloakServerSpec) DeepCopyInto(out *EntandoKeycloakServerSpec) {
	*out = *in
	if in.EnvironmentVariables != nil {
		in, out := &in.EnvironmentVariables, &out.EnvironmentVariables
		*out = make([]corev1.EnvVar, len(*in))
...
func (in *EntandoKeycloakServerSpec) DeepCopy() *EntandoKeycloakServerSpec {
	if in == nil {
		return nil
	}
	out := new(EntandoKeycloakServerSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EntandoKeycloakServerStatus) DeepCopyInto(out *EntandoKeycloakServerStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EntandoKeycloakServerStatus.
func (in *EntandoKeycloakServerStatus) DeepCopy() *EntandoKeycloakServerStatus {
	if in == nil {
		return nil
	}
	out := new(EntandoKeycloakServerStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternallyProvidedServiceSpec) DeepCopyInto(out *ExternallyProvidedServiceSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternallyProvidedServiceSpec.
func (in *ExternallyProvidedServiceSpec) DeepCopy() *ExternallyProvidedServiceSpec {
	if in == nil {
		return nil
	}
	out := new(ExternallyProvidedServiceSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProvidedCapabilityList) DeepCopy() *ProvidedCapabilityList {
	if in == nil {
		return nil
	}
	out := new(ProvidedCapabilityList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProvidedCapabilitySpec) DeepCopyInto(out *ProvidedCapabilitySpec) {
	*out = *in
	...
	out.CapabilityParameters = in.CapabilityParameters
	out.SpecifiedCapability = in.SpecifiedCapability
	out.ExternallyProvidedService = in.ExternallyProvidedService
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProvidedCapabilitySpec.
func (in *ProvidedCapabilitySpec) DeepCopy() *ProvidedCapabilitySpec {
	if in == nil {
		return nil
	}
	out := new(ProvidedCapabilitySpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProvidedCapabilityStatus) DeepCopy() *ProvidedCapabilityStatus {
	if in == nil {
		return nil
	}
	out := new(ProvidedCapabilityStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SpecifiedCapabilitySpec) DeepCopy() *SpecifiedCapabilitySpec {
	if in == nil {
		return nil
	}
	out := new(SpecifiedCapabilitySpec)
	in.DeepCopyInto(out)
	return out
}
