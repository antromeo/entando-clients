...
// EntandoAppApplyConfiguration represents an declarative configuration of the EntandoApp type for use
// with apply.
...
// EntandoApp constructs an declarative configuration of the EntandoApp type for use with
// apply.
func EntandoApp(name, namespace string) *EntandoAppApplyConfiguration {
	b := &EntandoAppApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("EntandoApp")
...
func (b *EntandoAppApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
