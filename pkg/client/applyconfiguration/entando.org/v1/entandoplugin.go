...
// EntandoPluginApplyConfiguration represents an declarative configuration of the EntandoPlugin type for use
// with apply.
...
// EntandoPlugin constructs an declarative configuration of the EntandoPlugin type for use with
// apply.
func EntandoPlugin(name, namespace string) *EntandoPluginApplyConfiguration {
	b := &EntandoPluginApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("EntandoPlugin")
...
func (b *EntandoPluginApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
