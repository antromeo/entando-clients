...
// ProvidedCapabilityApplyConfiguration represents an declarative configuration of the ProvidedCapability type for use
// with apply.
...
// ProvidedCapability constructs an declarative configuration of the ProvidedCapability type for use with
// apply.
func ProvidedCapability(name, namespace string) *ProvidedCapabilityApplyConfiguration {
	b := &ProvidedCapabilityApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("ProvidedCapability")
...
func (b *ProvidedCapabilityApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
