...
// EntandoKeycloakServerApplyConfiguration represents an declarative configuration of the EntandoKeycloakServer type for use
// with apply.
...
// EntandoKeycloakServer constructs an declarative configuration of the EntandoKeycloakServer type for use with
// apply.
func EntandoKeycloakServer(name, namespace string) *EntandoKeycloakServerApplyConfiguration {
	b := &EntandoKeycloakServerApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("EntandoKeycloakServer")
...
func (b *EntandoKeycloakServerApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
