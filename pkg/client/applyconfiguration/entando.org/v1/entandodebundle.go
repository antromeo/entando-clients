...
// EntandoDeBundleApplyConfiguration represents an declarative configuration of the EntandoDeBundle type for use
// with apply.
...
// EntandoDeBundle constructs an declarative configuration of the EntandoDeBundle type for use with
// apply.
func EntandoDeBundle(name, namespace string) *EntandoDeBundleApplyConfiguration {
	b := &EntandoDeBundleApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("EntandoDeBundle")
...
func (b *EntandoDeBundleApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
