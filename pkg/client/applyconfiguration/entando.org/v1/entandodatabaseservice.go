...
// EntandoDatabaseServiceApplyConfiguration represents an declarative configuration of the EntandoDatabaseService type for use
// with apply.
...
// EntandoDatabaseService constructs an declarative configuration of the EntandoDatabaseService type for use with
// apply.
func EntandoDatabaseService(name, namespace string) *EntandoDatabaseServiceApplyConfiguration {
	b := &EntandoDatabaseServiceApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("EntandoDatabaseService")
	b.WithAPIVersion("entando.org/v1")
	return b
}
...
func (b *EntandoDatabaseServiceApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
