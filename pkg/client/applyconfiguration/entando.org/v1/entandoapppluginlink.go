...
// EntandoAppPluginLinkApplyConfiguration represents an declarative configuration of the EntandoAppPluginLink type for use
// with apply.
...
// EntandoAppPluginLink constructs an declarative configuration of the EntandoAppPluginLink type for use with
// apply.
func EntandoAppPluginLink(name, namespace string) *EntandoAppPluginLinkApplyConfiguration {
	b := &EntandoAppPluginLinkApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("EntandoAppPluginLink")
...
func (b *EntandoAppPluginLinkApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
