...
import (
	...
	"github.com/antromeo/entando-clients/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type EntandoV1Interface interface {
...
func (c *EntandoV1Client) EntandoApps(namespace string) EntandoAppInterface {
	return newEntandoApps(c, namespace)
}
...
// NewForConfigAndClient creates a new EntandoV1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*EntandoV1Client, error) {
	...
	return &EntandoV1Client{client}, nil
}

// NewForConfigOrDie creates a new EntandoV1Client for the given config and
...
func New(c rest.Interface) *EntandoV1Client {
	return &EntandoV1Client{c}
}
