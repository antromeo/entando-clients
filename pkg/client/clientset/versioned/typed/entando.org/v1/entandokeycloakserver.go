...
// EntandoKeycloakServersGetter has a method to return a EntandoKeycloakServerInterface.
...
// entandoKeycloakServers implements EntandoKeycloakServerInterface
type entandoKeycloakServers struct {
	client rest.Interface
	ns     string
}

// newEntandoKeycloakServers returns a EntandoKeycloakServers
func newEntandoKeycloakServers(c *EntandoV1Client, namespace string) *entandoKeycloakServers {
	return &entandoKeycloakServers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *entandoKeycloakServers) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.EntandoKeycloakServer, err error) {
	result = &v1.EntandoKeycloakServer{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("entandokeycloakservers").
		Name(name).
...
func (c *entandoKeycloakServers) List(ctx context.Context, opts metav1.ListOptions) (result *v1.EntandoKeycloakServerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.EntandoKeycloakServerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("entandokeycloakservers").
...
func (c *entandoKeycloakServers) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *entandoKeycloakServers) Create(ctx context.Context, entandoKeycloakServer *v1.EntandoKeycloakServer, opts metav1.CreateOptions) (result *v1.EntandoKeycloakServer, err error) {
	result = &v1.EntandoKeycloakServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("entandokeycloakservers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(entandoKeycloakServer).
		Do(ctx).
		Into(result)
	return
}
...
func (c *entandoKeycloakServers) Update(ctx context.Context, entandoKeycloakServer *v1.EntandoKeycloakServer, opts metav1.UpdateOptions) (result *v1.EntandoKeycloakServer, err error) {
	result = &v1.EntandoKeycloakServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entandokeycloakservers").
...
func (c *entandoKeycloakServers) UpdateStatus(ctx context.Context, entandoKeycloakServer *v1.EntandoKeycloakServer, opts metav1.UpdateOptions) (result *v1.EntandoKeycloakServer, err error) {
	result = &v1.EntandoKeycloakServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entandokeycloakservers").
...
func (c *entandoKeycloakServers) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *entandoKeycloakServers) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *entandoKeycloakServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.EntandoKeycloakServer, err error) {
	result = &v1.EntandoKeycloakServer{}
...
func (c *entandoKeycloakServers) Apply(ctx context.Context, entandoKeycloakServer *entandoorgv1.EntandoKeycloakServerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.EntandoKeycloakServer, err error) {
...
func (c *entandoKeycloakServers) ApplyStatus(ctx context.Context, entandoKeycloakServer *entandoorgv1.EntandoKeycloakServerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.EntandoKeycloakServer, err error) {
	if entandoKeycloakServer == nil {
		return nil, fmt.Errorf("entandoKeycloakServer provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
