...
// EntandoDeBundlesGetter has a method to return a EntandoDeBundleInterface.
...
// entandoDeBundles implements EntandoDeBundleInterface
type entandoDeBundles struct {
	client rest.Interface
	ns     string
}

// newEntandoDeBundles returns a EntandoDeBundles
func newEntandoDeBundles(c *EntandoV1Client, namespace string) *entandoDeBundles {
...
func (c *entandoDeBundles) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.EntandoDeBundle, err error) {
	result = &v1.EntandoDeBundle{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *entandoDeBundles) List(ctx context.Context, opts metav1.ListOptions) (result *v1.EntandoDeBundleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.EntandoDeBundleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("entandodebundles").
...
func (c *entandoDeBundles) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *entandoDeBundles) Create(ctx context.Context, entandoDeBundle *v1.EntandoDeBundle, opts metav1.CreateOptions) (result *v1.EntandoDeBundle, err error) {
	result = &v1.EntandoDeBundle{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("entandodebundles").
...
func (c *entandoDeBundles) Update(ctx context.Context, entandoDeBundle *v1.EntandoDeBundle, opts metav1.UpdateOptions) (result *v1.EntandoDeBundle, err error) {
	result = &v1.EntandoDeBundle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entandodebundles").
...
func (c *entandoDeBundles) UpdateStatus(ctx context.Context, entandoDeBundle *v1.EntandoDeBundle, opts metav1.UpdateOptions) (result *v1.EntandoDeBundle, err error) {
	result = &v1.EntandoDeBundle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entandodebundles").
...
func (c *entandoDeBundles) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *entandoDeBundles) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *entandoDeBundles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.EntandoDeBundle, err error) {
	result = &v1.EntandoDeBundle{}
...
func (c *entandoDeBundles) Apply(ctx context.Context, entandoDeBundle *entandoorgv1.EntandoDeBundleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.EntandoDeBundle, err error) {
...
func (c *entandoDeBundles) ApplyStatus(ctx context.Context, entandoDeBundle *entandoorgv1.EntandoDeBundleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.EntandoDeBundle, err error) {
	if entandoDeBundle == nil {
		return nil, fmt.Errorf("entandoDeBundle provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
