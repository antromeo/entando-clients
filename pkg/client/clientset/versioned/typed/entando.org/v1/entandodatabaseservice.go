...
// EntandoDatabaseServicesGetter has a method to return a EntandoDatabaseServiceInterface.
...
// entandoDatabaseServices implements EntandoDatabaseServiceInterface
type entandoDatabaseServices struct {
	client rest.Interface
	ns     string
}

// newEntandoDatabaseServices returns a EntandoDatabaseServices
func newEntandoDatabaseServices(c *EntandoV1Client, namespace string) *entandoDatabaseServices {
	return &entandoDatabaseServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *entandoDatabaseServices) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.EntandoDatabaseService, err error) {
	result = &v1.EntandoDatabaseService{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("entandodatabaseservices").
		Name(name).
...
func (c *entandoDatabaseServices) List(ctx context.Context, opts metav1.ListOptions) (result *v1.EntandoDatabaseServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.EntandoDatabaseServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("entandodatabaseservices").
...
func (c *entandoDatabaseServices) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *entandoDatabaseServices) Create(ctx context.Context, entandoDatabaseService *v1.EntandoDatabaseService, opts metav1.CreateOptions) (result *v1.EntandoDatabaseService, err error) {
	result = &v1.EntandoDatabaseService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("entandodatabaseservices").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(entandoDatabaseService).
		Do(ctx).
		Into(result)
	return
}
...
func (c *entandoDatabaseServices) Update(ctx context.Context, entandoDatabaseService *v1.EntandoDatabaseService, opts metav1.UpdateOptions) (result *v1.EntandoDatabaseService, err error) {
	result = &v1.EntandoDatabaseService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entandodatabaseservices").
...
func (c *entandoDatabaseServices) UpdateStatus(ctx context.Context, entandoDatabaseService *v1.EntandoDatabaseService, opts metav1.UpdateOptions) (result *v1.EntandoDatabaseService, err error) {
	result = &v1.EntandoDatabaseService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("entandodatabaseservices").
...
func (c *entandoDatabaseServices) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *entandoDatabaseServices) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *entandoDatabaseServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.EntandoDatabaseService, err error) {
	result = &v1.EntandoDatabaseService{}
...
func (c *entandoDatabaseServices) Apply(ctx context.Context, entandoDatabaseService *entandoorgv1.EntandoDatabaseServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.EntandoDatabaseService, err error) {
...
func (c *entandoDatabaseServices) ApplyStatus(ctx context.Context, entandoDatabaseService *entandoorgv1.EntandoDatabaseServiceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.EntandoDatabaseService, err error) {
	if entandoDatabaseService == nil {
		return nil, fmt.Errorf("entandoDatabaseService provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
